...
module.exports = {
    root: path.resolve("./public"), // Path to css, js and img folders
    ...
    cssRules: {
        ...
        noUnderscores: false, // Complains about using underscores in your class names
        noUniversalSelectors: false, // Complains about using the universal * selector
